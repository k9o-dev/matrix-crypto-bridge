...
ANDROID_DIR="$PROJECT_ROOT/fortress-crypto-android"
...
echo "  1. Libraries are ready in fortress-crypto-android/src/main/jniLibs/"
echo "  2. Open Android Studio"
echo "  3. Import fortress-crypto-android module"
...
echo "  2. Run: cd fortress-crypto-android && gradle build"
echo "  3. AAR file will be in: fortress-crypto-android/build/outputs/aar/"
